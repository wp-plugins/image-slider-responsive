...
* Search for 'Image Slider Responsive' a plugin will come called 'Image Slider Responsive by Sayful Islam' and Click 'Install Now' and confirm your installation by clicking 'ok'
...
* From here, browse for the zip file included in your plugin titled 'image-slider-responsive.zip' and click the 'Install Now' button
* Once installation is complete, activate the plugin to enable its features.

Install by FTP

* Find the directory titles 'image-slider-responsive' and upload it and all files within to the plugins directory of your WordPress install (WORDPRESS-DIRECTORY/wp-content/plugins/) [e.g. www.yourdomain.com/wp-content/plugins/]
...
Do you have questions or issues with Images Slider Responsive? [Ask for support here.](http://sayful1.wordpress.com/100-2/)

== Screenshots ==

1. Screenshot of Images Slider.
